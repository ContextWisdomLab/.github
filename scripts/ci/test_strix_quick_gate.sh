...
assert_opencode_review_uses_codegraph_and_gpt5_fallback() {
	...
	assert_file_contains "$workflow_file" 'OPENCODE_MODEL_ATTEMPTS: "4"' "opencode fallback allows enough attempts to survive API instability"
	...
	assert_file_contains "$workflow_file" 'OPENCODE_MODEL_ATTEMPTS: "4"' "opencode primary allows enough attempts to survive API instability"
	assert_file_contains "$workflow_file" 'OPENCODE_MODEL_ATTEMPTS: "4"' "opencode catalog fallback allows enough attempts to survive API instability"

...
assert_opencode_review_uses_codegraph_and_gpt5_fallback() {
	...
	assert_file_contains "$workflow_file" 'cd "$1" && uv run pytest tests --cov' "opencode coverage evidence measures uv-managed Python projects inside their project environment"

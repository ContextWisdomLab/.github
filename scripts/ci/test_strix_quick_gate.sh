...
assert_opencode_review_uses_codegraph_and_gpt5_fallback() {
	...
	assert_file_contains "$workflow_file" "::warning::OpenCode review approved the PR, but merge scheduler dispatch did not start after retries" "opencode scheduler dispatch failure is a warning after approval"
